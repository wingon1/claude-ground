...
/**
 * Cozy Cove — a hand-held 3D diorama. Exported as a default React component so
 * the gallery can lazy-load it: none of the heavy three.js scene is downloaded
 * or run until the visitor actually opens this project.
 */
export default function CozyCove() {
  return (
