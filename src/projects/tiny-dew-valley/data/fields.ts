...
export const FIELD_PLOTS: FieldPlotDef[] = [
  { id: 'field_1', name: '1번 밭', x: 31, y: 16, sign: { x: 32, y: 15 } },
  { id: 'field_2', name: '2번 밭', x: 27, y: 16, sign: { x: 28, y: 15 } },
  { id: 'field_3', name: '3번 밭', x: 23, y: 16, sign: { x: 24, y: 15 } },
  { id: 'field_4', name: '4번 밭', x: 31, y: 20, sign: { x: 32, y: 19 } },
  { id: 'field_5', name: '5번 밭', x: 27, y: 20, sign: { x: 28, y: 19 } },
