...
export const MINE_FLOORS: MineFloorDef[] = [
  ...
  },
  {
    ...
    monsters: [{ id: 'slime', count: 1 }, { id: 'bat', count: 1 }],
    passiveDropChance: 0.05,
  ...
  },
  {
    ...
    monsters: [{ id: 'bat', count: 1 }, { id: 'mine_rat', count: 2 }],
    passiveDropChance: 0.07,
    rarityChance: { normal: 0.78, rare: 0.2, epic: 0.02 },
  },
  {
  ...
  },
  {
    ...
    monsters: [{ id: 'mine_rat', count: 2 }, { id: 'stone_golem', count: 1 }],
    passiveDropChance: 0.09,
    rarityChance: { normal: 0.65, rare: 0.3, epic: 0.05 },
  },
  {
    ...
    monsters: [{ id: 'mine_rat', count: 2 }, { id: 'stone_golem', count: 2 }],
  ...
  },
  {
    ...
    monsters: [{ id: 'stone_golem', count: 3 }],
