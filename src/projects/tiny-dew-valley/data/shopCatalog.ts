...
export const SHOP_CATALOG: ShopEntry[] = [
  { itemId: 'permit_chicken', buyPrice: 300, costItems: [{ itemId: 'wood', qty: 10 }], grantsFlag: CHICKEN_UNLOCK_FLAG },
  ...
  { itemId: 'permit_dairy', buyPrice: 1100, costItems: [{ itemId: 'wood', qty: 22 }], grantsFlag: DAIRY_UNLOCK_FLAG, requiresFlag: 'seen:item:strawberry_jam' },
  ...
  { itemId: 'permit_pig', buyPrice: 2600, costItems: [{ itemId: 'wood', qty: 35 }], grantsFlag: PIG_UNLOCK_FLAG, requiresFlag: DAIRY_UNLOCK_FLAG },
