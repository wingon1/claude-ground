...
| `building.tent.lv1` | 텐트 | 80x72 |
| `building.shop.lv1` | 상점 | 88x72 |
| `building.cooking_fire.lv1` | 요리불 | 56x48 |
| `building.storage.lv1` | 창고 | 56x48 |
| `building.mine_entrance.lv1` | 광산 입구 | 88x72 |
| `resource.tree.small` | 작은 나무 | 48x64 |
| `resource.tree.large` | 큰 나무 | 64x80 |
| `resource.rock.small` | 작은 바위 | 48x36 |
| `resource.rock.large` | 큰 바위 | 56x40 |
| `resource.bush.berry` | 덤불 | 48x36 |
| `resource.ore.node` | 광산 노드 | 40x36 |
| `plot.wheat.0..4` | 밀밭 성장 단계 | 48x32 |
